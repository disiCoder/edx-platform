...
def _advanced_component_types():
    ...
    """
    if settings.FEATURES.get('ALLOW_ORA1_PROBLEMS'):
        return ADVANCED_COMPONENT_TYPES
    else:
        return [c_type for c_type in ADVANCED_COMPONENT_TYPES if c_type not in OPEN_ENDED_COMPONENT_TYPES]
